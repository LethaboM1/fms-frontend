...
//   // Your actual plant master list data
//   const plantInfo = {
//     // Asphalt Pavers
...
//       // Add logo to the center if image exists
...
//         ctx.fillStyle = 'white';
//         ctx.fillRect(centerX - 3, centerY - 3, logoSize + 6, logoSize + 6);
//         ctx.strokeStyle = '#1b5e20';
//         ctx.lineWidth = 2;
//         ctx.strokeRect(centerX - 3, centerY - 3, logoSize + 6, logoSize + 6);
...
//           a.href = url;
//           a.download = `fuel-qr-${plantNumber}.png`;
...
//       logo.onerror = () => {
//         // If logo fails to load, just download without logo
//         canvas.toBlob((blob) => {
//           const url = URL.createObjectURL(blob);
//           const a = document.createElement('a');
//           a.href = url;
...
//             level="H"
//             includeMargin={false}
//             fgColor="#1b5e20" // Dark green dots
...
//                 const textFallback = e.target.parentElement.querySelector('.text-fallback');
...
//             <p style={{ margin: '5px 0' }}><strong>Fleet Number:</strong> {plantNumber}</p>
//             <p style={{ margin: '5px 0' }}><strong>Description:</strong> {currentPlant.name}</p>
//             <p style={{ margin: '5px 0' }}><strong>Type:</strong> {currentPlant.type}</p>
//             <p style={{ margin: '5px 0' }}><strong>Fuel Type:</strong> {currentPlant.fuelType}</p>
//             <p style={{ margin: '5px 0' }}><strong>Category:</strong> {currentPlant.category}</p>
//           </div>
//         </div>
...
//         }}>
//           <h4 style={{ color: '#1b5e20', marginBottom: '10px' }}>Scan Information</h4>
//           <p style={{ margin: '5px 0', fontSize: '14px' }}>
//             When scanned, this QR code will automatically fill the fleet number and retrieve equipment details for fuel transactions.
//           </p>
//         </div>
...
//           <p>Print and attach this QR code to the equipment for easy fuel tracking.</p>
//         </div>
//       </div>
//     </div>
//   );
...
const QRGenerator = ({ plantNumber, plantInfo, onClose }) => {
  const qrRef = useRef();
  ...
  }, [plantNumber, plantInfo]);

  const currentPlant = plantInfo || { 
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h4 style={{ color: '#1b5e20', marginBottom: '15px' }}>Equipment Information</h4>
          
          <div style={{ textAlign: 'left', lineHeight: '2' }}>
            <div><strong>Fleet Number:</strong> {plantNumber}</div>
