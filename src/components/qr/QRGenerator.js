...
//   // Simplified plant info (just keep a few for testing)
  // const plantInfo = {
  //   // Asphalt Pavers
...
//   // Set QR data when plantNumber changes - USING PLAIN TEXT FORMAT
//   useEffect(() => {
//     if (plantNumber) {
...
//       // Use plain text format that will display nicely when scanned
//       const dataToEncode = `
...
//     img.onload = () => {
//       // Draw QR code
//       ctx.drawImage(img, width / 2 - 100, 90, 200, 200);

//       // Equipment Information Box
//       ctx.fillStyle = '#f8f9fa';
//       ctx.fillRect(50, 320, width - 100, 350);
//       ctx.strokeStyle = '#dee2e6';
//       ctx.lineWidth = 2;
//       ctx.strokeRect(50, 320, width - 100, 350);

//       // Equipment Information Title
//       ctx.fillStyle = '#1b5e20';
//       ctx.font = 'bold 20px Arial';
//       ctx.textAlign = 'center';
//       ctx.fillText('EQUIPMENT INFORMATION', width / 2, 355);
...
//         ctx.fillText(detail, 80, 400 + (index * 30));
//       });
...
//       link.download = `equipment-${plantNumber}-qrcode.png`;
//       link.href = dataUrl;
...
//         }}>
//           <h5 style={{ color: '#1b5e20', marginBottom: '10px' }}>QR Code Content Preview</h5>
//           <div style={{
//             backgroundColor: 'white',
//             padding: '10px',
//             borderRadius: '4px',
...
//           <p>Scan this QR code with any QR scanner to view equipment details.</p>
//           <p><strong>Format:</strong> Plain Text (Human Readable)</p>
//         </div>
//       </div>
//     </div>
//   );
